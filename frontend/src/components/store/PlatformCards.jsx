...
import { FaShoppingCart, FaArrowLeft, FaSearch, FaFilter } from 'react-icons/fa';
...
const PlatformCards = () => {
  ...
  return (
    <div className="min-h-screen bg-black text-white">
      {/* Hero Section */}
      <div className={`relative bg-gradient-to-r ${platformColors[platformId] || 'from-purple-900 to-black'} py-16`}>
      ...
      <div className="max-w-7xl mx-auto px-6 py-12">
        ...
        <div className="flex flex-col md:flex-row justify-between items-center mb-10 bg-gray-900/50 p-4 rounded-xl border border-gray-800">
          <p className="text-gray-300 mb-4 md:mb-0">
            Showing {filteredProducts.length} of {products.length} products for {platformNames[platformId] || 'this platform'}
          </p>
              ...
              >
                <div className="h-48 overflow-hidden relative">
                  ...
                  <div className="absolute bottom-0 left-0 right-0 p-4 transform translate-y-full group-hover:translate-y-0 transition-transform duration-300">
                    <button 
                      className="w-full py-2 bg-yellow-500 hover:bg-yellow-400 text-black font-bold rounded-lg transition-colors flex items-center justify-center space-x-2"
